...
import brndimg from '../../assets/images/navbrand.png'
...
const About = () => {
    return (
        <div className="w-full md:w-3/4 mx-auto bg-white for_use_font_class px-3 md:px-6 py-2 md:py-6">
            <Link className='flex justify-center mb-2 md:mb-4' to={'/home'}>
                <img src={brndimg} alt="" />
            </Link>
            <div className="">
                ...
                <p className="text-slate-600 mb-4">The mission of the Transport Company may be categorized by 3 principal activities as follows.
                ...
                <p className="text-slate-600 mb-4">To be the leader of domestic land based transport, with world-class service standards, efficient management, employing modern technologies and quality personnel.</p>
